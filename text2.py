...
for i in range(2, 101): 
    ...
    try:
        ...
        continue  # Pula para a próxima iteração se o arquivo da matriz não for encontrado
    ...
    # Aplicar um colormap para colorir a matriz de calor
    ...
    # Misturar a matriz de calor com a imagem original (20% da imagem original e 90% da matriz de calor)
